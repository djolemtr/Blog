										...
										<tbody>
											...
											<c:forEach var="post" items="${postList}">
												...
												<tr>
													...
													<td class="text-center"><img src="${post.image}"
													...
													<td class="text-center">
														...
														<div class="btn-group">
															...
															</a> <a href="post-enable?id=${post.id}" class="btn btn-info">
																<c:if test="${post.enabled}">
																	<i class="fas fa-eye"></i>
																</c:if> <c:if test="${!post.enabled}">
																	<i class="fas fa-eye-slash"></i>
																</c:if>
															</a> <a href="post-mark-important?id=${post.id}"
																class="btn btn-info"> <c:if test="${post.important}">
																	<i class="fas fa-solid fa-minus"></i>
																</c:if> <c:if test="${!post.important}">
