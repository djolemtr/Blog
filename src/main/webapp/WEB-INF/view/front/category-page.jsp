...
<title>Blog by Djole - ${categoryName}</title>
		...
		<nav class="navbar navbar-expand-lg">
			...
			<div class="container">
				...
				<div
					...
					<!-- Navbar Brand -->
					<a href="${pageContext.request.contextPath}/index.html" class="navbar-brand">Blog by Djole</a>
					<!-- Toggle Button-->
						...
						<div class="blog-posts">
							<a href="blog-post.html">
								<div class="item d-flex align-items-center">
									<div class="image">
										<a
											href="${pageContext.request.contextPath}/post/${postListForLatestWidget[i].urlTitle}">
