...
<title>Blog - Admin - Change Password</title>
		...
		<nav
			...
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link" data-widget="pushmenu"
					href="user-list" role="button"><i class="fas fa-bars"></i></a></li>
			</ul>
						...
						<div class="col-md-12">
							<div class="card card-primary">
								...
								<form:form action="user-change-password-action"
									modelAttribute="changePassword" role="form" method="post">
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<form:input type="password" class="form-control"
														path="oldPassword" placeholder="Enter old password" />
													<form:errors path="oldPassword" cssClass="text-danger" />
												</div>
												<div class="form-group">
													<label>New password</label>
													<form:input type="password" class="form-control"
														path="newPassword" placeholder="Enter new password" />
													<form:errors path="newPassword" cssClass="text-danger" />
												</div>
												<div class="form-group">
													<label>Confirm password</label>
													<form:input type="password" class="form-control"
														path="confirmPassword" placeholder="Enter new password" />
