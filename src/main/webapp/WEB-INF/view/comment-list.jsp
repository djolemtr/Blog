				...
				<li class="nav-item dropdown"><a class="nav-link"
					...
					<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
						<a href="user-edit-profile" class="dropdown-item"> <i
							class="fas fa-user">&nbsp</i> <sec:authentication
								property="principal.username"></sec:authentication>&nbsp(click
							to edit)
						</a>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="card">
								...
								<!-- /.card-header -->
								<div class="card-body">
									<form action="comment-search" method="get">
										<div class="row">
											<div class="col-md-3 form-group">
												<label>Post ID: </label> <input type="number"
													class="form-control" placeholder="Search by post id"
													name="id">
											</div>
										</div>
