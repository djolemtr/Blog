...
<title>Blog - Admin - Slide List</title>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-primary">
								...
								<!-- /.card-header -->
								<!-- form start -->
								<form:form action="post-update-action" modelAttribute="post"
									role="form">
									<form:hidden path="id" />
									...
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
												...
												<div class="form-group">
													<label>Image</label> <img src="${post.image}" alt="..."
														class="img-fluid rounded" style="margin-bottom: 10px;">
												...
												<div class="form-group">
													...
													<form:select class="form-control" items="${categoryList}"
														itemLabel="name" itemValue="id" path="category.id" />
												</div>
												<div class="form-group">
													<label>Content</label>
													<form:textarea class="form-control" path="content"
														placeholder="Enter post content" rows="20" />
													<form:errors path="content" cssClass="text-danger" />
												</div>
												<div class="form-group">
													<label>Tags</label>

													<form:select path="tags" items="${tagList}"
									...
									<div class="card-footer">
										...
										<a href="post-list" class="btn btn-outline-secondary">Cancel</a>
									</div>
								</form:form>
							</div>
							<!-- /.card -->
