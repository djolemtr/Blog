						...
						<div class="col-md-12">
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Slide update</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<form:input type="number" min="1" class="form-control"
														path="order" placeholder="Enter slide order" />
												...
												<div class="form-group">
													<label>Button</label>
													<form:textarea class="form-control" path="button_name"
														placeholder="Enter button name" />
													<form:errors path="button_name" cssClass="text-danger" />
												</div>
												<div class="form-group">
													<label>Button URL</label>
													<form:textarea class="form-control" path="button_url"
														placeholder="Enter button url" />
													<form:errors path="button_url" cssClass="text-danger" />
												</div>
											</div>
